...
function checkPossibleRight() {
    if (post.value) {
        return (post.value[positions.value.indexOf(4)] == undefined) ? 'background-color: rgba(255, 255, 255, 0.35); cursor: not-allowed;' : 'background-color: white;'
    }
    return "background-color: white;"
}
function checkPossibleLeft() {
    if (post.value) {
        return (post.value[positions.value.indexOf(2)] == undefined) ? 'background-color: rgba(255, 255, 255, 0.35); cursor: not-allowed;' : 'background-color: white;'
    }
    return "background-color: white;"
}
</script>
