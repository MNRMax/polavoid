...
<template>
    <div id="navigationBar">
        ...
        <RouterLink id="account" v-if="sessionStore.session.value" :to="`/profile/${sessionStore.session.value.user.id}`">
            <img class="logos" src="/acct-logo.png" alt="account logo image" />
        </RouterLink>
        <RouterLink id="people" v-if="sessionStore.session.value" to="/people"><img class="logos" id="pplLogo"
                src="/PeopleLogo.png" alt="account logo image" />
        </RouterLink>
        <RouterLink id="create" v-if="sessionStore.session.value" to="/post"><img class="logos" src="/CreateLogo.png"
        ...
        <RouterLink id="aboutLink" to="/about"><img class="logos" id="aboutLogo" src="/About-Logo.png"
                alt="Light bulb logo image" />
        </RouterLink>
    </div>
    <RouterView />
